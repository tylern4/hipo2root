...
*/
std::string utils::substring(const std::string &str, const char *start_delim, const char *end_delim,
                             int order) {
  int position = 0;
...
std::string utils::getSConstruct() {
  ...
  std__string.append(
      "env.Append(CONFIGUREDIR=[\"/group/clas12/packages/lz4/lib\",\"/group/clas12/packages/hipo-io/"
      "lib\"])\n");
  std__string.append("#=================================================\n");
